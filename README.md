...
[![Version](https://img.shields.io/badge/version-v2.5.0-blue.svg)](https://github.com/Lyscf/FlowSage)
...
- **📡 新增Telnet协议支持**：完整的Telnet会话解析和重建
- **🔐 Telnet密码分析**：智能识别和提取登录凭据
- **💻 终端内容还原**：完整重现Telnet会话的终端操作内容
- **📁 HTTP文件自动提取**：默认自动提取所有HTTP传输的文件
